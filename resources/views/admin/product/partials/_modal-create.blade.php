...
<div class="modal fade" id="modalQuickProduct" tabindex="-1" aria-labelledby="modalQuickProductLabel" aria-hidden="true" style="z-index: 1070;">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" style="max-height: 90vh;">
        <form id="formQuickProduct" class="modal-content shadow-lg border-0 h-100" enctype="multipart/form-data">
            @csrf
            <div class="modal-header bg-primary text-white py-2 flex-shrink-0">
            ...
            <div class="modal-footer py-2 bg-light flex-shrink-0">
