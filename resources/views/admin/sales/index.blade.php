                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <x-bootstrap.select name="filter_bank_account" id="filter-bank-account" :options="$bankAccounts"
                                placeholder="Todas las Cuentas" class="form-select-sm" container-class="mb-0 d-none" />
                        </div>
